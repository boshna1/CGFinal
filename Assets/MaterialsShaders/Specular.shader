        ...
        Pass
        {
            Tags {"LightMode" = "ForwardBase"}
                ...
                float4 frag (Output i) : COLOR
                {
                    ...
                    float3 specularReflect = atten * _SpecColor.rgb * shininessPower;
                    float3 lightFinal = diffuseReflection + specularReflect +UNITY_LIGHTMODEL_AMBIENT;
